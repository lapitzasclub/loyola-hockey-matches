...
export const i18n = {
  es: {
    ...
    team_selector_onboarding_intro: "Elige el equipo de Loyola que quieras seguir dentro de las distintas competiciones y torneos en los que participa el club.",
    ...
    team_detail_title: "Detalle del equipo",
    team_detail_summary: "Resumen del equipo",
    team_detail_matches: "Partidos del equipo",
    team_detail_points: "Puntos",
    team_detail_played: "Partidos jugados",
    team_detail_won: "Partidos ganados",
    team_detail_drawn: "Partidos empatados",
    team_detail_lost: "Partidos perdidos",
    team_detail_goals_for: "Goles a favor",
    team_detail_goals_against: "Goles en contra",
    team_detail_goal_difference: "Diferencia de goles",
    team_detail_no_matches: "No hay partidos disponibles para este equipo.",
    team_detail_no_matches_for_filter: "No hay partidos para este filtro.",
    team_detail_open_match: "Abrir detalle del partido",
    team_detail_loading: "Cargando equipo...",
    team_detail_tab_summary: "Resumen",
    team_detail_tab_matches: "Partidos",
    team_detail_tab_roster: "Plantilla",
    ...
    team_detail_filter_active_label: "Filtro activo",
    team_detail_filter_clear: "Limpiar",
    team_detail_filter_showing: (count) => `Mostrando ${count} partidos`,
    team_detail_roster_unavailable: "La plantilla no está disponible todavía para esta competición.",
    team_detail_roster_generated_from_lineups: "Plantilla generada a partir de alineaciones registradas.",
    team_detail_roster_generated_from_loaded_lineups: "Plantilla generada a partir de alineaciones detectadas en partidos disponibles.",
    team_detail_roster_empty_from_lineups: "Todavía no hay alineaciones suficientes para construir la plantilla de este equipo.",
    team_detail_roster_unknown_player: "Jugador sin identificar",
    team_detail_roster_appearances: (count) => `${count} apariciones`,
    team_detail_roster_loading: "Cargando plantilla...",
    team_detail_stats_empty: "Todavía no hay partidos jugados suficientes para mostrar estadísticas.",
    team_detail_stats_form: "Racha reciente",
    team_detail_stats_overview: "Resumen estadístico",
    team_detail_stats_home_away: "Balance local / visitante",
    team_detail_stats_home: "Local",
    team_detail_stats_away: "Visitante",
    team_detail_stats_avg_for: "Promedio a favor",
    team_detail_stats_avg_against: "Promedio en contra",
    team_detail_stats_win_rate: "% victorias",
    team_detail_stats_clean_sheets: "Porterías a cero",
    team_detail_stats_scoreless: "Partidos sin marcar",
    team_detail_stats_home_away_chart: "Rendimiento casa / fuera",
    team_detail_stats_penalties: "Penaltis a favor",
    team_detail_stats_direct_fouls: "Faltas directas a favor",
    team_detail_stats_fouls_for: "Faltas realizadas",
    team_detail_stats_fouls_against: "Faltas recibidas",
    team_detail_stats_blue_cards_for: "Azules realizadas",
    team_detail_stats_blue_cards_against: "Azules recibidas",
    team_detail_stats_red_cards_for: "Rojas realizadas",
    team_detail_stats_red_cards_against: "Rojas recibidas",
    team_detail_stats_penalties_for: "Penaltis a favor",
    team_detail_stats_penalties_against: "Penaltis en contra",
    team_detail_stats_penalties_scored_for: "Penaltis marcados",
    team_detail_stats_penalties_scored_against: "Penaltis encajados",
    team_detail_stats_penalties_missed_for: "Penaltis fallados",
    team_detail_stats_penalties_missed_against: "Penaltis defendidos",
    team_detail_stats_direct_fouls_for: "Faltas directas a favor",
    team_detail_stats_direct_fouls_against: "Faltas directas en contra",
    team_detail_stats_direct_fouls_scored_for: "Faltas directas marcadas",
    team_detail_stats_direct_fouls_scored_against: "Faltas directas encajadas",
    team_detail_stats_direct_fouls_missed_for: "Faltas directas falladas",
    team_detail_stats_direct_fouls_missed_against: "Faltas directas defendidas",
    team_detail_stats_set_pieces: "Penaltis y faltas directas",
    team_detail_stats_range_all: "Toda",
    team_detail_stats_no_form: "Sin racha disponible",
    team_detail_stats_goals_timeline: "Evolución de goles",
    team_detail_stats_results_distribution: "Distribución de resultados",
    team_detail_stats_last_matches: (count) => `Últimos ${count} partidos`,
    team_detail_stats_loading: "Cargando estadísticas avanzadas...",
    team_detail_stats_charts_title: "Gráficas",
    team_detail_stats_discipline_chart: "Disciplina",
    team_detail_form_won: "V",
    team_detail_form_drawn: "E",
    team_detail_form_lost: "D",
  },
  eu: {
    ...
    team_selector_onboarding_intro: "Aukeratu klubak parte hartzen duen txapelketa eta torneoen artean jarraitu nahi duzun Loyola taldea.",
    ...
    team_detail_title: "Taldearen xehetasuna",
    team_detail_summary: "Taldearen laburpena",
    team_detail_matches: "Taldearen partidak",
    team_detail_points: "Puntuak",
    team_detail_played: "Partidak jokatuak",
    team_detail_won: "Partida irabaziak",
    team_detail_drawn: "Partida berdinduak",
    team_detail_lost: "Partida galduak",
    team_detail_goals_for: "Aldeko golak",
    team_detail_goals_against: "Kontrako golak",
    team_detail_goal_difference: "Gol diferentzia",
    team_detail_no_matches: "Ez dago partidarik eskuragarri talde honentzat.",
    team_detail_no_matches_for_filter: "Ez dago partidarik iragazki honetarako.",
    team_detail_open_match: "Partidaren xehetasuna ireki",
    team_detail_loading: "Taldea kargatzen...",
    team_detail_tab_summary: "Laburpena",
    team_detail_tab_matches: "Partidak",
    team_detail_tab_roster: "Plantilla",
    team_detail_filter_all: "Guztiak",
    team_detail_filter_pending: "Jokatu gabe",
    team_detail_filter_toolbar: "Taldearen partiden iragazkiak",
    team_detail_filter_active_label: "Iragazki aktiboa",
    team_detail_filter_clear: "Garbitu",
    team_detail_filter_showing: (count) => `${count} partida erakusten`,
    team_detail_roster_unavailable: "Plantilla oraindik ez dago eskuragarri lehiaketa honetarako.",
    team_detail_roster_generated_from_lineups: "Hamaikakoa erregistratutako lerrokadetan oinarrituta sortua.",
    team_detail_roster_generated_from_loaded_lineups: "Plantilla partida erabilgarrietako lerrokaduretatik sortua.",
    team_detail_roster_empty_from_lineups: "Oraindik ez dago talde honen plantilla eraikitzeko nahikoa lerrokadurarik.",
    team_detail_roster_unknown_player: "Identifikatu gabeko jokalaria",
    team_detail_roster_appearances: (count) => `${count} agerraldi`,
    team_detail_roster_loading: "Plantilla kargatzen...",
    ...
    team_detail_stats_home_away: "Etxean / kanpoan balantzea",
    team_detail_stats_home: "Etxean",
    team_detail_stats_away: "Kanpoan",
    team_detail_stats_avg_for: "Alde batez bestekoa",
    team_detail_stats_avg_against: "Kontra batez bestekoa",
    team_detail_stats_win_rate: "Garaipen %",
    team_detail_stats_clean_sheets: "Aterpea hutsean",
    team_detail_stats_scoreless: "Golik gabeko partidak",
    team_detail_stats_home_away_chart: "Etxean / kanpoan errendimendua",
    team_detail_stats_penalties: "Aldeko penaltiak",
    team_detail_stats_direct_fouls: "Aldeko falta zuzenak",
    team_detail_stats_fouls_for: "Egindako faltak",
    team_detail_stats_fouls_against: "Jasotako faltak",
    team_detail_stats_blue_cards_for: "Egindako urdinak",
    team_detail_stats_blue_cards_against: "Jasotako urdinak",
    team_detail_stats_red_cards_for: "Egindako gorriak",
    team_detail_stats_red_cards_against: "Jasotako gorriak",
    team_detail_stats_penalties_for: "Aldeko penaltiak",
    team_detail_stats_penalties_against: "Kontrako penaltiak",
    team_detail_stats_penalties_scored_for: "Sartutako penaltiak",
    team_detail_stats_penalties_scored_against: "Jasotako penalti golak",
    team_detail_stats_penalties_missed_for: "Huts egindako penaltiak",
    team_detail_stats_penalties_missed_against: "Gelditutako penaltiak",
    team_detail_stats_direct_fouls_for: "Aldeko falta zuzenak",
    team_detail_stats_direct_fouls_against: "Kontrako falta zuzenak",
    team_detail_stats_direct_fouls_scored_for: "Sartutako falta zuzenak",
    team_detail_stats_direct_fouls_scored_against: "Jasotako falta zuzen golak",
    team_detail_stats_direct_fouls_missed_for: "Huts egindako falta zuzenak",
    team_detail_stats_direct_fouls_missed_against: "Gelditutako falta zuzenak",
    team_detail_stats_set_pieces: "Penaltiak eta falta zuzenak",
    team_detail_stats_range_all: "Denak",
    team_detail_stats_no_form: "Ez dago boladarik erabilgarri",
    team_detail_stats_goals_timeline: "Golen bilakaera",
    team_detail_stats_results_distribution: "Emaitzen banaketa",
    team_detail_stats_last_matches: (count) => `Azken ${count} partidak`,
    team_detail_stats_loading: "Estatistika aurreratuak kargatzen...",
    team_detail_stats_charts_title: "Grafikoak",
    team_detail_stats_discipline_chart: "Diziplina",
    team_detail_form_won: "I",
    team_detail_form_drawn: "B",
    team_detail_form_lost: "G",
  },
};
